...
function HeroSection() {
  return (
    <section className="bg-[#EEFBF3]">
      <InnerNav />
      <div className="relative pt-20 w-full flex lg:flex-row justify-between items-center lg:gap-16 md:gap-12 gap-8 flex-col h-[50rem] main-container">
        <aside className="h-[20em] relative lg:w-1/2 w-full">
          <img
            src="/shape-8.webp"
            alt=""
          ...
          <p className=" text-black  lg:text-5xl md:text-3xl text-2xl font-sans leading-[3.5rem]">
        ...
        <aside className="lg:w-1/2 w-full relative">
          <img
            src="/slider-1.webp"
            alt=""
            className="w-full float-right right-16 top-3 z-10 object-contain"
          />
        ...
        <div className="absolute lg:right-10 right-2 -top-28 lg:top-5">
          <img
            src="/shape-7.webp"
            alt=""
            className=" relative right-5  top-[20rem] top-bottom-move"
          />
          <div className="bg-white rounded-full lg:h-[125px] lg:w-[125px] h-[100px] w-[100px]">
