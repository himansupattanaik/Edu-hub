    ...
    return (
        <div className="h-full w-full space-y-3 bg-transparent p-5 rounded-lg border hover:border-green-300 cursor-pointer">
            <Link href="DetailsPageHerosection">
                ...
                <p className="hover:text-green-500 w-full ml-5">{item.desc}</p>
                <div className=" flex justify-between mx-5 my-5 text-sm">
                    <div ><Schedule className=" text-green-700" />{item.duration}</div>
                    <div><MenuBook className=" text-green-700" /> {item.lecture}</div>
                ...
                <div className=" bg-[#EEFBF3] p-6  h-14 rounded-xl flex items-center justify-between">
                    ...
                    <p className="">{item.rating} <span> <Star className="text-yellow-500  text-lg" /><Star className="text-yellow-500 text-lg" /><Star className="text-yellow-500 text-lg" /><Star className="text-yellow-500 text-lg" /><StarBorder className="text-yellow-500 text-lg" /> </span></p>
