    ...
    <>
      <section className="relative bg-emerald-50">
        ...
        <img
          ...
          alt=""
        />
        <div className="lg:h-[40vh] h-[67vh] w-full flex flex-col lg:flex-row items-center justify-between my-9">
          <aside className="lg:w-1/2 text-sm md:text-lg lg:text-xl">
            <div className="h-24 main-container mx-4 lg:mx-10">
              <div className="absolute bottom-24 lg:left-52 md:left-12 md:bottom-24 left-4 leading-[3rem]">
                <span className="">
          ...
          <aside className="w-full lg:w-1/2 flex flex-col lg:flex-row relative items-center justify-center mt-6 lg:mt-0">
            ...
            <img className=" bottom-48 right-20 w-24  lg:w-40 md:w-28 absolute lg:left-36 lg:top-0 md:right-60 md:bottom-24" src="/shape-6.webp" alt="" />

            <img
              className="shape-5 hidden md:block lg:block absolute lg:-top-32 lg:right-1/2 md:bottom-52 md:right-40"
              src="/shape-5.webp"
              alt=""
            />
            <div className="absolute lg:right-20 lg:-bottom-[7rem] md:right-20 md:-bottom-[2.5rem] ">
              <img className="rounded-full relative  left-40 top-10 lg:left-60  lg:top-[30rem] md:top-[12rem]  md:left-40 lg:h-40 lg:w-40 md:h-28 md:w-28 h-20 w-20" src="/author-11.webp" alt="" />

              <img className="z-0  h-60 md:h-[70vh]  bottom-40 -right-16 md:bottom-10  relative lg:top-9" src="/shape-24.webp" alt="" />
            </div>
          </aside>
        </div>
      </section>
