...
const Footer = () => {
  return (
    <section className="relative w-full  bg-[#E7F8EE] sm:top-20">
      <div className="relative w-full  mx-auto">
        <img
          src="/shape-21.webp"
          alt=""
          className="absolute top-8  left-6 z-0 top-bottom-move"
        />
        ...
        />
        <main className="  w-[80%]  ml-28 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 z-10 ">
      ...
      <footer className="bg-gray-800 text-white mt-20 mb-0 py-5 p-24">
